...
function love.draw()
    ...
    if Paused == 'yes' then
        love.graphics.circle('line', VIRTUAL_WIDTH / 2, VIRTUAL_HEIGHT / 2, 66)
        love.graphics.rectangle('fill', VIRTUAL_WIDTH/2 - 30, VIRTUAL_HEIGHT/3, 20,90)
        love.graphics.rectangle('fill', VIRTUAL_WIDTH/2 + 10, VIRTUAL_HEIGHT/3, 20,90)
    end
    push:finish()
end
